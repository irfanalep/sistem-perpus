import { getOrdersUser } from "./user-data.js";
...
export function renderUserMenu(menu, menuListElement, ordersListElement, totalPriceElement) {
    ...
    for (const coffee of menu) {
        ...
        button.addEventListener("click", async function () {
            ...
            // Ngambil data order baru dan render ke UI
            const newUserOrder = await getOrdersUser();
                      
            if (!newUserOrder.status) {
                alert(newUserOrder.message);
                return;
            }

            renderUserOrders(newUserOrder.data, menu.data, ordersListElement)
            renderUserTotalPrice(newUserOrder.data, menu, totalPriceElement)
